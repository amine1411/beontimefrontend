//-----------------------------------------
// CLIENTS GERER
// Main de la Gestion des Clients
//-----------------------------------------
...
function ClientsGerer() {
  ...
  useEffect(() => {
    axios.get("http://localhost:3000/clients/all").then((res) => {
  ...
  function handleDeleteClient(idClient) {
    axios.delete(`http://localhost:3000/clients/${idClient}`).then((res) => {
      // Log du retour
  ...
  // Declenchée par le composant MissionModify
    ...
    <>
      ...
      >
        ...
        >
          ...
          {showCreateClient && (
            <ClientCreate
              handleCreateClientClose={handleCreateClientClose}
            />
          )}
