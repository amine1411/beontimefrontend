...
function CollaborateursGerer() {
  ...
  function handleDeleteCollaborateur(username) {
    ...
    axios.delete(`http://localhost:3000/users/${username}`).then((res) => {
      // Log du retour
...
export default CollaborateursGerer;
